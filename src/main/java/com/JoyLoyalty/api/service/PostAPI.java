    ...
    public static String getBodyFromMethodForChallenge(String endPoint, String testcase) throws Exception {
        ...
        //--Start Challenge 03 Payload
            ...
            return "{\n" +
                    ...
                    "  \"surveyData\": null\n" +
                    "}";
        } else if (endPoint.equalsIgnoreCase("CompleteChallenge05") && (testcase.equalsIgnoreCase("ChallengewithWrongChallengeType"))) {
            return "{\n" +
                    "  \"challengeId\": 15837,\n" +
                    "  \"challengeType\": [\n" +
                    "    \"poinwts\"\n" +
            ...
            return "{\n" +
                    ...
                    "  ]\n" +
                    "}";
        } else if (endPoint.equalsIgnoreCase("CompleteChallenge14") && (testcase.equalsIgnoreCase("ChallengewithWrongChallengeType"))) {
            return "{\n" +
                    "  \"challengeId\": 18538,\n" +
                    "  \"challengeType\": [\n" +
                    "    \"prizwe\"\n" +
            ...
            return "{\n" +
                    ...
                    "  \"surveyData\": null\n" +
                    "}";
        } else if (endPoint.equalsIgnoreCase("CompleteChallenge15") && (testcase.equalsIgnoreCase("ChallengewithWrongChallengeType"))) {
            return "{\n" +
                    "  \"challengeId\": 17925,\n" +
                    "  \"challengeType\": [\n" +
                    "    \"prwize\"\n" +
