...
import com.au.loyalty.api.service.RegistrationAPI;
...
public class JoyAccountDetailsAPI extends Basecode {
    ...
    public Response getResponseDetails(HashMap<String, Object> dataMap, String endpoint,String testcase) throws Exception {
