...
public class LoadProperties {
    static String auLoyaltyPropertiesFile = "config/configAULoyalty.properties";
    static String latamColumbiaPropertiesFile = "config/configLatam.properties";
    static String latamBrazilPropertiesFile = "config/configB2BLatamBR.properties";
    static String commonConfigPropertiesFile = "config/commonConfig.properties";
    ...
    public static String getEUSpainPropertyValue(String propertyKey) throws Exception {
        String propertyValue;
        propertyValue = readEUSpainConfigProperty(propertyKey);
        return propertyValue;
    }
    ...
    public static String readEUSpainConfigProperty(String key) {
        String value = null;
    ...
    public String getAppServerForProject(String project) throws Exception {
        ...
        switch (getProject()) {
            case "columbia":
                apiServer = readCommonConfigProperty("co_QA_apiserver")+readCommonConfigProperty("QA_apiversion");
                break;
            case "brazil":
                apiServer = getLatamBrazilPropertyValue("br_QA_apiserver")+getLatamBrazilPropertyValue("QA_apiversion");
                break;
            case "spain":
                apiServer = getEUSpainPropertyValue("es_QA_apiserver")+getLatamBrazilPropertyValue("QA_apiversion");
                break;
            case "dominic":
                apiServer = getEUSpainPropertyValue("dr_QA_apiserver")+getLatamBrazilPropertyValue("QA_apiversion");
                break;
            default:
    ...
    public static String getjoyLoyaltyPropertyValue(String propertyKey) throws Exception {
        String propertyValue;
        propertyValue = readCommonConfigProperty(propertyKey);
        return propertyValue;
    }
