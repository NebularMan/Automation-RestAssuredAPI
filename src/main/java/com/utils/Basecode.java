...
public class Basecode extends LoadProperties {
    ...
    private PropertiesConfiguration config = new PropertiesConfiguration("config/configAULoyalty.properties");
    private PropertiesConfiguration latamconfig = new PropertiesConfiguration("config/configLatam.properties");
    private PropertiesConfiguration JOYconfig = new PropertiesConfiguration("config/configjoyLoyalty.properties");
    ...
    public HashMap<String, String> updateSiteIdxAPIKeyHeaderForProject(String project) throws Exception {
        ...
        switch (project) {
            case "columbia":
                headerMap.put("siteId", getLatamColumbiaPropertyValue("columbiasiteid"));
                headerMap.put("x-api-key", getLatamColumbiaPropertyValue("x-api-key"));
                break;
            case "brazil":
                headerMap.put("siteId", getLatamBrazilPropertyValue("brazilsiteid"));
                headerMap.put("x-api-key", getLatamBrazilPropertyValue("x-api-key"));
                break;
            case "spain":
                headerMap.put("siteId", getEUSpainPropertyValue("spainsiteid"));
                headerMap.put("x-api-key", getEUSpainPropertyValue("x-api-key"));
                break;
            case "WhatsApp":
                ...
                break;
            case "dominic":
                headerMap.put("siteId", getLatamColumbiaPropertyValue("dominicsiteid"));
                headerMap.put("x-api-key", getLatamColumbiaPropertyValue("dominic-x-api-key"));
                break;
...
//    }
    ...
    public String getjoyServerUrl() throws Exception {
        String apiUrl = null;
        System.out.println(System.getProperty("environment"));
        switch ("QA") {
            case "QA":
                apiUrl = getjoyLoyaltyPropertyValue("QA_apiserver") +
                        getjoyLoyaltyPropertyValue("QA_apiversion");
                break;
            case "UAT":
                apiUrl = getjoyLoyaltyPropertyValue("UAT_apiserver") +
                        getjoyLoyaltyPropertyValue("UAT_apiversion");
                break;
            default:
                apiUrl = getjoyLoyaltyPropertyValue("QA_apiserver") +
                        getjoyLoyaltyPropertyValue("QA_apiversion");
    ...
    public String getOktaServerUrl() throws Exception {
        String apiUrl = null;
        System.out.println(System.getProperty("environment"));
        switch ("OKTA-Dev") {
            case "OKTA-Dev":
                apiUrl = getjoyLoyaltyPropertyValue("QA_OKTAapiserver") +
                        getjoyLoyaltyPropertyValue("QA_OKTAapiversion");
                break;
            case "OKTA-Prod":
                apiUrl = getjoyLoyaltyPropertyValue("Prod_OKTAapiserver") +
                        getjoyLoyaltyPropertyValue("QA_OKTAapiversion");
                break;
    ...
    public String getsfmcServerUrl() throws Exception {
        String apiUrl = null;
        System.out.println(System.getProperty("environment"));
        switch ("SFMC-Dev") {
            case "SFMC-Dev":
                apiUrl = getjoyLoyaltyPropertyValue("QA_SFMCapiserver");
                break;
        }
        return apiUrl;
    }
    ...
    public void updateID(String key, int value) throws Exception {
        JOYconfig.setProperty(key, value);
        JOYconfig.save();
        System.out.println("Updated key " + key + " value as " + value);
    }

    public static HashMap<String, String> getSiteIdMap(String strProject, HashMap<String, String> headerMap) throws Exception {
        switch (strProject) {
            case "columbia":
                headerMap.put("siteId", getCommonConfigPropertyValue("columbiasiteid"));
                break;
            case "brazil":
                headerMap.put("siteId", getCommonConfigPropertyValue("brazilsiteid"));
                break;
            case "spain":
                headerMap.put("siteId", getCommonConfigPropertyValue("spainsiteid"));
                break;
            case "dominic":
                headerMap.put("siteId", getCommonConfigPropertyValue("dominicsiteid"));
                break;
    ...
    public static HashMap<String, String> getXapiKeyMap(String strProject, HashMap<String, String> headerMap) throws Exception {
        switch (strProject) {
            case "columbia":
                headerMap.put("x-api-key", getCommonConfigPropertyValue("columbiax-api-key"));
                break;
            case "brazil":
                headerMap.put("x-api-key", getCommonConfigPropertyValue("brazilx-api-key"));
                break;
            case "spain":
                headerMap.put("x-api-key", getCommonConfigPropertyValue("spainx-api-key"));
                break;
            case "dominic":
                headerMap.put("x-api-key", getCommonConfigPropertyValue("dominicx-api-key"));
                break;
