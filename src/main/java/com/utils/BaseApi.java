    ...
    public static Response delAPI(Object body ,Map<String, String> headerMap, String url)
        ...
        Response response =
                rest.given()
                        ...
                        .when()
                        .delete(url);
        logger.info("DELETE call to URL " + url);
        logger.info("GET Response" + response.prettyPrint());
        return response;
    }

    public static Response delAPI(String delBody ,Map<String, String> headerMap, String url)
            throws Exception{
        RestAssured rest = null;
        Response response =
                rest.given()
...
//        headerMap.put("x-api-key", readCommonConfigProperty(getProject()+"x-api-key"));
    ...
    public static Response postAPIforSFMC(Object body,
                                   String url) throws Exception {
        RestAssured rest = null;
        Response response =
                rest.given()
    ...
    public static Response putSFMCAPI(String payload,Map<String, String> headerMap,
                                  String url) throws Exception {
        RestAssured rest = null;
        Response response =
                rest.given()
    ...
    public static Response postAccountsAPI(String payload,Map<String, String> headerMap,
                                      String url) throws Exception {
        RestAssured rest = null;
        Response response =
                rest.given()
