...
public class ChangePasswordApi extends Basecode {
    ...
    public ChangePasswordApi(ScenarioContext context) throws Exception {
        ...
        apiUrl = getlatamServerUrl() + LoadProperties.readCommonConfigProperty("changePassword");
        LoadProperties.logger.info("Change password API URL :- " + apiUrl);
    }
    ...
    public Object getChangePasswordRequestBodyFromJson() throws Exception {
        ...
        String path = usrdir + LoadProperties.getLatamColumbiaPropertyValue("changePasswordJson");
    ...
    public Response getChangePasswordResponse(HashMap<String,Object> testdata, String endpoint) throws Exception {
            ...
            switch (testField) {
                ...
                case "oldPassword":
                    ...
                    if (testVal.equalsIgnoreCase("invalidvalue")) {
                        ...
                        requestMap.put(valuefield, LoadProperties.getLatamColumbiaPropertyValue("newPassword"));
                    }
                    break;
                case "newPassword":
        ...
        Response response = BaseApi.postAPI(bodyMap, getSiteIdOktaHeaderAsMap(endpoint), apiUrl);
        ...
        if(responseMap.containsKey("provider")){
            updatelatamConfigValue("newPassword", pwd);
        }
        return response;
    }
}
