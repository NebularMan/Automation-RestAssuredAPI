...
public class GetAPI extends Basecode {
    ...
    /**
     * Method to send request with x-api-key and siteId hearder and get products,Reward details,RewardList,GetStoreDetails,
     * Content,Product,DeliveryEstimate,Holidays,OrderHistory,Translation API response
     * @return response
     */
    public Response getAPIResponseHeaderxapikeysiteId(HashMap<String, Object> dataMap , String endpoint) throws Exception {
    ...
    public Response getAPIResponseHeaderonTestdata(HashMap<String, Object> dataMap , String endpoint) throws Exception {
        HashMap<String, String> headerMap = new HashMap<>();
        String loginWith = getLatamColumbiaPropertyValue("LoginWith");
        headerMap = updateSiteIdxAPIKeyHeaderForProject(getProject());
        apiServer = getAppServerForProject(getProject());
        ...
        switch (endpoint) {
            case "GamesList":
                apiUrl = apiServer+ readCommonConfigProperty("GamesList");
                break;
