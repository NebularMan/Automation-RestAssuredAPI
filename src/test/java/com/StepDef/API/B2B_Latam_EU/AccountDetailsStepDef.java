package com.StepDef.API.B2B_Latam_EU;

import com.b2b.latameu.api.service.*;
    ...
    public void sendGetRequestToLatamFor(String endpoint, String testcase) throws Exception {
        ...
        switch (endpoint) {
            ...
            case "Okta":
                ...
                break;
            case "GetAccountDetails": case "GetCart": case "RewardList": case "GetStoreDetails": case "Content": case "Product":
            case "DeliveryEstimate": case "Holidays": case "OrderHistory": case "Translation": case "SalesTarget": case "Faq":
            case "ActivityList": case "BalancePoints": case "VendorList": case "Favorite": case "SuggestedSKU":
                response = getAPI.getAPIResponseHeaderxapikeysiteId(dataMap, endpoint);
                break;
            case "GamesList":
                response = getAPI.getAPIResponseHeaderonTestdata(dataMap, endpoint);
                break;
    ...
    public void verifyLatamDetailsApiResponseFor(String endpoint, String testcase) throws Exception {
        ...
        if (actResponseMap.containsKey("metadata")) {
            ...
            for (Map.Entry metaEle : metaResMap.entrySet()) {
                ...
                if(expectedField.equalsIgnoreCase("itemKey") || expectedField.equalsIgnoreCase("itemType")) {
        ...
        } else if(actResponseMap.containsKey("msg")) {
        ...
        } else if(actResponseMap.containsKey("errorCode")) {
            for (Map.Entry mapElement : expResponseMap.entrySet()) {
                expectedField = (String) mapElement.getKey();
                testVal = (String) expResponseMap.get(expectedField);
                System.out.println("ExpectedField :" +expectedField+ "   "+"TestValue :" +testVal );
